...
| Erlang       | Strict        | Dynamic | ?              | Yes                      | No  | No  | ?   | ?    | VM          |               | ?        | Telecommunications, Servers, Concurrency |
| JavaScript   | Strict        | Dynamic | No             | No                       | Yes | No  | Yes | No   | Interpreted | *Lisp/ Scheme | No       | Only language that runs in the browser.  |
|              |               |         |                |                          |     |     |     |      |             |               |          |                                          |
| R            | Strict        | Dynamic | No             | No                       | ?   | No  | Yes | -    | VM          | *Lisp/ Scheme | No       | DSL - Statics                            |
