...
*Examples:*
 ...
 - Python: Functions are values and can be passed as argument and
...
#+END_SRC
 ...
 - Functions can be stored in data strcutures: 
...
*Reading type signatures:*
 ...
 - ~main :: IO ()~ is an IO action, not a function. 
...
#+BEGIN_SRC haskell
  ...
  {- | Not Haskell has a function for this: sequence_ -}
...
IO Actions allows to build functions that works like control
structures.
...
It is not possible to do in a non-pure language. Example in F#
(Fsharp).
...
was designed to by as simple as possible. 
