...
Get all pythagorean numbers from 1 to 100. A Pythagorean numbers are
three integers that satisfies the equation c^2 = a^2 + b^2
...
#+END_SRC
*** TODO Options for comprehensions
** Exception Handling 
*** Overview 
