...
MVC Variation: 
 ...
 - Controller as mediator. The model doesn't interact directly with
   the view. It updates the view through the controller. This MVC
   variation is widely used in Apple's Cocoa framework.
...
[[file:src/counterMvcExample.png][file:src/counterMvcExample.png]]
