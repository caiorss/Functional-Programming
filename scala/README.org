...
**** Example in Functional way 
     :PROPERTIES:
     :ID:       50b40ac2-98e9-40cb-ab9e-0984e1ef3c22
     :END:

As Scala is a functional language, it allows functions be passed
directly as argument, therefore the observer object be replaced by a
_callback_ function and _subject_ by a list or set of callbacks. 
