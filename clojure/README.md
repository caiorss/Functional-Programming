...
## Basic Syntax<a id="sec-1-3" name="sec-1-3"></a>
...
## IO / Input and Output<a id="sec-1-6" name="sec-1-6"></a>
...
![img](images/Clojure_Inspector_methods.png)
